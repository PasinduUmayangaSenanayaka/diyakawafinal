...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO guide (guide_name, description, address, mobile, email) 
            VALUES ('$guide_name', '$description', '$address', '$mobile', '$email')";
    ...
    if ($db->query($sql) === TRUE) {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Success',
          text: 'New guide added successfully',
...
$result = $db->query("SELECT * FROM guide");
