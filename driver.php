...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO driver (driver_name, description, address, mobile, email) 
            VALUES ('$driver_name', '$description', '$address', '$mobile', '$email')";
...
$result = $db->query("SELECT * FROM driver");
