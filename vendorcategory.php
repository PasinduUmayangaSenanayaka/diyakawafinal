...
// Handle form submission for inserting vendor category
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $vendor_category = $_POST['vendor_category'];
    $prefix = $_POST['prefix'];

    // Insert data into vendor_category table
    $sql = "INSERT INTO vendor_category (vendor_category, prefix) VALUES ('$vendor_category', '$prefix')";
    ...
    if ($db->query($sql) === TRUE) {
        ...
        echo "<div class='alert alert-danger'>Error: " . $sql . "<br>" . $db->error . "</div>";
    }
}
      ...
      <div class="content-wrapper">
        ...
        <form method="POST" action="">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="vendor_category" name="vendor_category" required>
            </div>
            <div class="mb-3">
        ...
        <!-- Display the vendor categories in a table -->
